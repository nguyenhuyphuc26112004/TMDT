...
<body>
    <?php
        ...
        $totalProducts = getTotalProducts($con, 'san_pham', 'Giỏ trái cây'); // Get total products
        $totalPages = ceil($totalProducts / $itemsPerPage); // Calculate total pages

        $offset = ($currentPage - 1) * $itemsPerPage;
        $sanPham = getObjectByCondition($con, 'san_pham', 'Giỏ trái cây', $offset, $itemsPerPage); // Adjust this function to accept offset and limit
    ?>
