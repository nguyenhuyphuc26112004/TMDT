...
<body>
    <?php
        ...
        $totalProducts = getTotalProducts($con, 'san_pham', 'Trái cây Việt Nam'); // Get total products
        $totalPages = ceil($totalProducts / $itemsPerPage); // Calculate total pages

        $offset = ($currentPage - 1) * $itemsPerPage;
        $sanPham = getObjectByCondition($con, 'san_pham', 'Trái cây Việt Nam', $offset, $itemsPerPage); // Adjust this function to accept offset and limit
    ?>
    <div class="container">
