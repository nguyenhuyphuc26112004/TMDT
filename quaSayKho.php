...
<body>
    <?php
        ...
        $totalProducts = getTotalProducts($con, 'san_pham', 'Quả sấy khô'); // Get total products
        $totalPages = ceil($totalProducts / $itemsPerPage); // Calculate total pages

        $offset = ($currentPage - 1) * $itemsPerPage;
        $sanPham = getObjectByCondition($con, 'san_pham', 'Quả sấy khô', $offset, $itemsPerPage); // Adjust this function to accept offset and limit
    ?>
